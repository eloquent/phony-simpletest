...
use Eloquent\Phony\Simpletest\Test\TestEvent;
...
class PhonyTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $actual = Phony::mockBuilder('Eloquent\Phony\Simpletest\Test\TestClassA');
        ...
        $this->assertInstanceOf('Eloquent\Phony\Simpletest\Test\TestClassA', $actual->get());
    }

    public function testMockBuilderFunction()
    {
        $actual = mockBuilder('Eloquent\Phony\Simpletest\Test\TestClassA');
    ...
    {
        $types = array('Eloquent\Phony\Simpletest\Test\TestClassB', 'Countable');
        ...
        $this->assertInstanceOf('Eloquent\Phony\Mock\Mock', $actual->get());
        $this->assertInstanceOf('Eloquent\Phony\Simpletest\Test\TestClassB', $actual->get());
    ...
    public function testMatcherIntegration()
    {
        ...
        $this->assertTrue((bool) $spy->checkCalledWith(new EqualExpectation('a')));
    }
